...
//import com.example.web.springboot.config.autho.dto.SessionUser;
//import com.example.web.springboot.service.PostsService;
//import com.example.web.springboot.web.PostsResponseDto;
import com.example.web.springboot.service.PostsService;
...
//
    ...
    public String postsUpdate(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("post",dto);  //post update mustache로감
